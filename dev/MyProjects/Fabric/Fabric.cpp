//***************************************************************************************
// Fabric.cpp by Frank Luna (C) 2015 All Rights Reserved.
//
...
Fabric::Fabric(HINSTANCE hInstance)
    : D3DApp(hInstance)
{
}
...
void Fabric::OnKeyboardInput(const GameTimer& gt)
{
...
void Fabric::UpdateWaves(const GameTimer& gt)
{
...
void Fabric::BuildWavesGeometryBuffers()
{
...
float Fabric::GetHillsHeight(float x, float z)const
{
    return 0.3f*(z*sinf(0.1f*x) + x*cosf(0.1f*z));
}

XMFLOAT3 Fabric::GetHillsNormal(float x, float z)const
{
    // n = (-df/dx, 1, -df/dz)
    XMFLOAT3 n(
